...
"Error",
    ...
    Private Async Sub install(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Dim fileUrl As String = "https://github.com/TrollboxDevelopersUnited/WinTrollbox/releases/download/v5.0/wowa7zfile.7z"
            ...
            sevenZup.Arguments = $"x ""{Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "Downloads\") & "wowa7zfile.7z"}"" -o""{Path.Combine(Path.GetTempPath(), "Trollbox")}"" -y"
